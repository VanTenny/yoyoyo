...
const Index = () => {
  ...
  const galleryImages: { src: string; title: string; description: string; objectPosition?: string }[] = [
    ...
    { src: "/lovab;e-uploads/EP_36.jpeg", title: "EP_26", description: "Graduation Photoshoot of Engineering Physics batch'26" },
    { src: "/lovab;e-uploads/Milan.jpeg", title: "Milan", description: "At Doumoo di Milano, Italy" },
    { src: "/lovab;e-uploads/Norway.jpeg", title: "Norway", description: "Homecooked dinner by me, Nanako and Asumi for our international friends at UiA, Kristiansand" },
    { src: "/lovab;e-uploads/Oslo.jpeg", title: "Oslo", description: "The upper deck of Astrup Fearnley Museum of Modern Art in Oslo, Norway" },
    { src: "/lovab;e-uploads/paris.jpeg", title: "Paris", description: "At a museum in Paris, France", objectPosition: "center 55%" },
    { src: "/lovab;e-uploads/priekestolen.jpeg", title: "Preikestolen (Pulpit Rock)", description: "Sumitted a world famous nature's wonder Preikestolen, Norway" },
